...
Using my previous experience I started my web design agency, focused on UI development. I'd both create the designs as well as implement them according to the specifications of the clients.
...
During this time I learned a lot about management, marketing, and how to help your clients discover what they need rather than what they think they want.

In a few cases, we teamed up with freelancers to be able to offer a bigger service package to varying degrees of success. Learning how to find someone you can trust to get the job done as well as fit the client's style was a very important part of the process.

I shut the agency down in 2018 due to health problems that led to severe burnout, even though we were starting to gain traction in the market.
...
Front-end developer for a B2B route planning and vehicle tracking system. I worked on the transition from PHP and AngularJs to Angular 2, to update the legacy code the project contained.
...
While I don't think it was the wrong move to make, I was in no way prepared for what changing to the web truly meant. My inexperience in the business led to me not fully understanding what I had to offer to provide value to my clients. And so the packages I offered were lackluster, even if I was priced considerably under market value.

I learned a lot about the market I wanted to operate in during this time and felt it best to close up shop and focus on really learning the skills and understanding what the market needed before launching myself again.
...
This is when I decided that it was what I wanted to get into, and paved the way for the rest.
